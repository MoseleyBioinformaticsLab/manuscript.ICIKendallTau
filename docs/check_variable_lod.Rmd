...
```{r}
#| label: figure-100-400
tbl_100 = tibble::tibble(value = c(var_lod_samples_100$data), n_sample = "100")
tbl_400 = tibble::tibble(value = c(var_lod_samples_400$data), n_sample = "400")
tbl_data = dplyr::bind_rows(tbl_100, tbl_400)

tbl_data |>
  ggplot(aes(x = value, color = n_sample)) + 
  geom_density() +
  labs(subtitle = "Data value density plot for 100 and 400 samples.")
```
