...
Additional support for the hypothesis that missing values are **primarily** due to being below the limit of detection is provided by the binomial test for left censorship (see Implementation), with the results shown in `r table_count$label_text("n-missing")`.
