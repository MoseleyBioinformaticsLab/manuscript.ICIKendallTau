...
Correlations were calculated between samples when no missing values are present (*reference*), and then again after censoring (*lod*).
...
Possible different levels of censoring based on dynamic range were checked by first determining how many missing values would be introduced in each sample as the censoring was increased in increments of 0.1.
