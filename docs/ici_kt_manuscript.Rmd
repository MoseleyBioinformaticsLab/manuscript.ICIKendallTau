...
Moreover, our implementation of ICI-Kt uses the mergesort-like algorithm that provides O(nlog(n)) computational performance, a significant improvement over the Kendall-tau correlation available in base R.
...
\
**Other requirements:** R $\geq$ 3.5, Python $\geq$ 3.8
\
**License:** MIT
\
