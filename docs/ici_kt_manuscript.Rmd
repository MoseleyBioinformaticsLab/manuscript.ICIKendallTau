...
If the value is **less than** the median value in the sample, that is counted as a **success** in a binomial test, otherwise it is counted as a failuer.
...
We created a dataset of with 1000 features and 100 samples, starting with a sample from a random log-normal distribution with a mean-log value of 1, and standard deviation of 0.5.
