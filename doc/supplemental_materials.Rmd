...
tar_load(positive_kt)
tar_load(positive_pearson)
tar_load(negative_kt)
tar_load(negative_pearson)
...
tar_load(c(yeast_paper_outliers,
           yeast_outliers,
           yeast_single))
...
tar_load(c(brainsonrnaseq_outliers,
