...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, fig.height = 6, fig.keep = "all")
...
loadd(brainsonrnaseq_outliers_75)
loadd(brainsonrnaseq_outliers_100)

brainsonrnaseq_outs_ic = list(
  ...
  x_075 = brainsonrnaseq_outliers_75$icikt_complete,
  x_100 = brainsonrnaseq_outliers_100$icikt_complete
)
brainsonrnaseq_outs_ic = purrr::imap(brainsonrnaseq_outs_ic, function(in_out, in_name){
  in_out$which = in_name
  in_out
})

brainsonrnaseq_out_compare_ic = compare_outlier_tables(brainsonrnaseq_outs_ic,
                                    c("x_01" = "1 Sample",
                                      "x_025" = "25% of Class",
                                      "x_050" = "50% of Class",
                                      "x_075" = "75% of Class",
                                      "x_100" = "100% of Class"),
                                    "x_100")
brainsonrnaseq_out_plot_ic = brainsonrnaseq_out_compare_ic$plot_data
```

```{r brainsonrnaseq_fractions_plot_ic}
ggplot(brainsonrnaseq_out_plot_ic, aes(x = sample_class, y = med_cor, color = outlier, group = sample_class)) +
  geom_sina() +
  facet_wrap(~ method, nrow = 1) +
  labs(subtitle = "ICI-Kt * Completeness")
```

```{r brainsonrnaseq_fractions_i}
brainsonrnaseq_outs_i = list(
  x_01 = brainsonrnaseq_outliers_1$icikt,
  x_025 = brainsonrnaseq_outliers_25$icikt,
  x_050 = brainsonrnaseq_outliers_50$icikt,
  x_075 = brainsonrnaseq_outliers_75$icikt,
  x_100 = brainsonrnaseq_outliers_100$icikt
)
brainsonrnaseq_outs_i = purrr::imap(brainsonrnaseq_outs_i, function(in_out, in_name){
  in_out$which = in_name
  in_out
})

brainsonrnaseq_out_compare_i = compare_outlier_tables(brainsonrnaseq_outs_i,
                                    c("x_01" = "1 Sample",
                                      "x_025" = "25% of Class",
                                      "x_050" = "50% of Class",
                                      "x_075" = "75% of Class",
                                      "x_100" = "100% of Class"),
                                    "x_100")
brainsonrnaseq_out_plot_i = brainsonrnaseq_out_compare_i$plot_data
```

```{r brainsonrnaseq_fractions_plot_i}
ggplot(brainsonrnaseq_out_plot_i, aes(x = sample_class, y = med_cor, color = outlier, group = sample_class)) +
  geom_sina() +
  facet_wrap(~ method, nrow = 1) +
  labs(subtitle = "ICI-Kt")
```
...
Pushing to a 50% minimum for the "type" of sample ends up pushing the minimum of presence in tumors to 100%.
...
brainsonrnaseq_alts = list(
  x_01 = brainsonrnaseq_outliers_1_alt$icikt_complete,
  x_025 = brainsonrnaseq_outliers_25_alt$icikt_complete,
  x_050 = brainsonrnaseq_outliers_50_alt$icikt_complete
)
