...
tar_load(c(lod_graph_adenocarcinoma,
           lod_graph_tumorcultures,
           lod_graph_nsclc,
           lod_graph_micediabetics,
           positive_kt,
           positive_pearson,
           negative_kt,
           all_kt,
...
```{r}
#| label: lod_tumorcultures
#| fig.width: 10
#| fig.height: 8 
wrap_plots(lod_graph_tumorcultures, ncol = 1) + plot_annotation(tag_levels = "A")
```
...
```{r}
#| label: lod_micediabetics
#| fig.width: 10
#| fig.height: 8
wrap_plots(lod_graph_micediabetics, ncol = 1) + plot_annotation(tag_levels = "A")
```
