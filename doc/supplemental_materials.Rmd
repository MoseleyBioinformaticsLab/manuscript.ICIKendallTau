...
supp_figure_count$increment("egfrgenotype_by_method")
supp_figure_count$increment("egfrgenotype_by_keep_num")
supp_figure_count$increment("egfrgenotype_differences")
```
