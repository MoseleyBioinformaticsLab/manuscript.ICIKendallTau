...
Counts were normalized using `DESeq2` with the growth environment as the grouping factor.
...
**Fill this in.**
Intensities were normalized by the median abundance of all quantified peaks in a sample.

### Diabetic Mice Metabolomics Data Set

**Fill this in.**
Intensities were normalized by the non-zero peak abundances in each sample.
