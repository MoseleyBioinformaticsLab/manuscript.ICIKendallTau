...
With both simulated and real data sets from RNA-seq, metabolomics and lipidomics experiments, we demonstrate that the ICI-Kt allows for the inclusion of missing data values as interpretable information, which allows improved determination of outlier samples, and improved feature-feature network construction, without explicitly using imputation.
...
For each dataset and correlation-related metric, the median correlation for a sample was calculated amongst the samples for each sub-group of samples corresponding to an experimental condition of interest (disease, mutant, how cells were grown, condition, etc).
