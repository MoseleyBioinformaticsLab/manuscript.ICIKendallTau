...
To our knowledge, information-content-informed Kendall-tau is the first correlation method that explicitly attempts to include the effect of missing not at random data from missing values that occur due to being below the detection limit. 
...
Kendall-tau correlation as missing values are varied between two samples and replaced with 0.
