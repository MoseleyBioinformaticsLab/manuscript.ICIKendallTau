...
```{r include_figure1, counter_identifer = figure_count$label_file("problem")}
...
```{r compare_realistic, fig.width = 8, fig.height = 8, counter_identifier = figure_count$label_file("missing2cor")}
...
```{r left_censored_vs_random, fig.height = 8, fig.width = 8, counter_identifier = figure_count$label_file("leftcensored")}
...
```{r show_performance_graph, counter_identifier = figure_count$label_file("singleperf")}
...
```{r dependence_number, counter_identifier = figure_count$label_file("multiperformance")}
...
```{r yeast_outlier_figure, counter_identifier = figure_count$label_file("yeast_outliers")}
yeast_single %>%
  add_method() %>%
...
```{r brainsonseq_figure, counter_identifier = figure_count$label_file("brainson_outliers")}
brainson_single %>%
  add_method() %>%
...
```{r adeno_figure, counter_identifier = figure_count$label_file("adeno_outliers")}
adeno_single %>%
  add_method() %>%
...
```{r load_ici_timings, fig.height = 8, fig.width = 5, counter_identifier = figure_count$label_file("icisubsampling")}
...
```{r poor_pca_var, counter_identifier = figure_count$label_file("pcavardifference")}
...
```{r nonrandom_pca, counter_identifier = figure_count$label_file("pcaeval")}
