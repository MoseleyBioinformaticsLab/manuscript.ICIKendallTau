...
The simplest scenario is to create three samples, where two are perfectly correlated, and the second perfectly anti-correlated, and replace the values in each systematically with missing values (in this case NA), and compute the ICI-Kt, Pearson, and Kendall correlations.
