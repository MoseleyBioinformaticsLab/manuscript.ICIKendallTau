...
figure_count = increment_count(figure_count, "kt_pearson")
figure_count = increment_count(figure_count, "kt_distribution")
```

`r paste_label("Figure S", figure_count, "kt_pearson")`. Comparison of ICI-Kt and Pearson correlations.
...
These distributions are shown in `r paste_label("Figure S", figure_count, "kt_distribution")`.
...
```{r complexity_label}
figure_count = increment_count(figure_count, "supp_complexity")
```
...
The run times and fitted lines for each method (R's Pearson, the ICI-Kt, and R's Kendall-tau) are shown in `r paste_label("Figure S", figure_count, "supp_complexity")`.
...
`r paste_label("Figure S", figure_count, "supp_complexity")`. Time in seconds needed as a function of the number of features, with a fitted line for the assumed complexity for each of the methods tested, including R's Pearson correlation, the ICI-Kt mergesort, and R's Kendall-tau correlation algorithm.
