...
In the case of Pearson correlation (see `r supp_figure_count$label_text("pearson_subsampling")`), the deviations between feature subsample and full feature set correlation values are much, much larger, with deviations decreasing much slower as compared to ICI-Kt and Kendall-tau.
In fact, the standard deviation of Pearson feature subsample correlations never get as small as those obtained from ICI-Kt and Kendall-tau.
...
To our surprise, ICI-Kt was far superior to Pearson at estimating correlation values from subsamples of features.
