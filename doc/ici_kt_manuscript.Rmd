...
```{r load_ici_timings}
reshaped_random = readRDS(here::here("data", "reshaped_random.rds"))
reshaped_nonrandom = readRDS(here::here("data", "reshaped_nonrandom.rds"))

ggplot(reshaped_random, aes(x = fraction, y = value)) + 
  geom_line() + 
