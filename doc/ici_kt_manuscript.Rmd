...
**Fig X**. The effect on correlation as increasing numbers of entries in either or both samples are replaced with missing values for ICI-Kt, Kendall, and Pearson.
